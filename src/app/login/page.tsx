      ...
      <div className="hidden md:flex md:w-1/2 bg-card border-r border-border/50 relative overflow-hidden flex-col justify-between p-12 lg:p-16">
        ...
        <div className="relative z-10 my-auto max-w-lg space-y-6">
          ...
          <h1 className="text-4xl lg:text-5xl font-extrabold tracking-tight text-foreground leading-[1.15]">
            Turn One Piece of Content Into <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-500">Dozens</span>
          </h1>
          <p className="text-lg text-muted-foreground leading-relaxed">
            Log in to access your dashboard, generate ready-to-publish assets, schedule campaigns, and track platform virality.
          </p>

          <div className="pt-4 border-t border-border/30 space-y-4">
            <div className="flex gap-4 items-start">
              <div className="bg-primary/10 p-2 rounded-lg text-primary text-xs font-semibold">
                92%
              </div>
              <div>
                <h4 className="font-medium text-foreground text-sm">Time Saved</h4>
                <p className="text-xs text-muted-foreground">Average content creation time reduced from 12 hours to 45 minutes.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <Link href="#forgot" className="text-xs text-primary hover:underline font-medium">
                  Forgot password?
                </Link>
              </div>
              <Input
            ...
            <Button
              ...
              disabled={loading || !!providerLoading || !email || !password}
            >
              {loading ? (
